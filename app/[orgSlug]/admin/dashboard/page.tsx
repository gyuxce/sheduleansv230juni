...
export default async function AdminDashboardPage({ params }: { params: Promise<{ orgSlug: string }> }) {
  ...
  const stats = error ? emptyStats : ((data as DashboardStats | null) ?? emptyStats);
  const cards = [
